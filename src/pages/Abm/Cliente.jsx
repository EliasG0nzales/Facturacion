...
const Cliente = () => {
  ...
  const clientesFiltrados = clientes.filter((c) => {
    ...
    if (tipoBusqueda === "1")
      return c.nombre.toLowerCase().includes(textoBusqueda.toLowerCase());
    if (tipoBusqueda === "2") return c.ruc.includes(textoBusqueda);
    if (tipoBusqueda === "3")
      return c.dpto.toLowerCase().includes(textoBusqueda.toLowerCase());
    if (tipoBusqueda === "4")
      return c.vendedor.toLowerCase().includes(textoBusqueda.toLowerCase());
    return true;
  });
  ...
  const guardar = () => {
    if (!form.nombre || !form.ruc)
      return showMsg("danger", "Nombre y RUC son obligatorios.");
    if (modal === "nuevo") {
    ...
    <>
      ...
      <div className="page-container">
        ...
        {msg.texto && (
          <div
            className={
              msg.tipo === "success" ? "alert-success" : "alert-danger"
            }
          >
        ...
        <div className="buscar-section">
          ...
          <button className="botonVerde" onClick={abrirNuevo}>
            ✚ Agregar Nuevo
          </button>
        </div>
                ...
                <tr key={c.id}>
                  ...
                  <td>
                    <div className="acciones">
                      ...
                      <button
                        className="btn-accion btn-cotizar"
                        title="Cotizar"
                      >
                        ⁂
                      </button>
                      <button className="btn-accion btn-vender" title="Vender">
                        💰
                      </button>
                      <button
        ...
        <div className="leyenda">
          ...
          <span style={{ color: "skyblue", fontSize: 16 }}>✏️</span> Actualizar,
          Eliminar &nbsp;&nbsp;
